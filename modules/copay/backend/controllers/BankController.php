...
namespace modules\copay\backend\controllers;
 ...
 *
 * @package modules\copay\backend\controllers
 */
class BankController extends Controller{
			...
			'access' => [
				'rules' => [
					[
						'allow'       => TRUE,
						'actions'     => ['index'],
						'permissions' => ['copay bank'],
					],
					[
						'allow'       => TRUE,
						'actions'     => ['active', 'create', 'update'],
						'permissions' => ['copay bank upsert'],
					],
					[
						'allow'       => TRUE,
						'actions'     => ['delete'],
						'permissions' => ['copay bank delete'],
					],
				]
			]
		];
	...
	public function actionCreate(){
		...
		if (Yii::$app->request->isAjax && $model->load(Yii::$app->request->post())){
			...
			$this->flash('success', Yii::t('copay', 'Bank has been created successfully'));
		}
	...
	public function actionUpdate($id){
		...
		if (Yii::$app->request->isAjax && $model->load(Yii::$app->request->post())){
			...
			$this->flash('success', Yii::t('copay', 'Bank has been updated successfully'));
		}
	...
	public function actionDelete($id){
		...
		$this->flash('success', Yii::t('copay', 'Bank has been deleted successfully'));
