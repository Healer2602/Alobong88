...
$this->title = Yii::t('copay', 'Copay Banks');
	...
	<div class="bank-index">
		<div class="filter">
			<form class="form-inline" action="" method="get">
				...
				<div class="input-group">
					<label class="control-label"><?= Yii::t('common', 'Visibility') ?></label>
					<?= Html::dropDownList('visibility', $filtering['visibility'] ?? NULL,
						...
						if (Yii::$app->user->can('copay bank upsert')){
							$result .= Html::a('<i class="fe fe-edit-2"></i>',
								...
								[
									...
									'data-bs-toggle' => "modal",
									'data-bs-target' => "#global-modal",
									'data-header'    => Yii::t('copay', 'Update Bank')
								]
							);
						}

						if (Yii::$app->user->can('copay bank delete')){
