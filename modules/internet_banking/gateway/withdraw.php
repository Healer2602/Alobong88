 ...
 * @var \modules\internet_banking\models\WithdrawForm $model
	...
	<div class="mb-4">
		<div class="custom-options bank-listing">
			<div class="row align-items-center">
				<label class="col-lg-3 mb-lg-0 mb-3">
					...
					<div class="row row-cols-md-2 row-cols-1 g-2">
						...
						<div class="col mb-2 add-bank">
							<div class="form-check h-100">
								<label class="form-check-label h-100 p-2 text-small" href="<?= Url::to(['default/add-bank', 'form' => TRUE]) ?>" data-bs-toggle="modal" data-bs-target="#modal-gateway-add-bank">
