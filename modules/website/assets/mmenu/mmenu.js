!function (e) {
    ...
    var f = {Menu: "منو"}, u = {Menu: "Menü"}, v = {Menu: "Меню"};
    ...
    class S {
        ...
        openPanel(e, t) {
            if (this.trigger("openPanel:before", [e]), e && (e.matches(".mm-panel") || (e = e.closest(".mm-panel")), e)) {
                if ("boolean" != typeof t && (t = !0), e.parentElement.matches(".mm-listitem_vertical")) {
                    ...
                    let s = e.mmParent;
                    for (; s;) {
                        (s = s.closest(".mm-panel")) && (s.parentElement.matches(".mm-listitem_vertical") || s.classList.add("mm-panel_opened-parent"), s = s.mmParent);
                    }
                    n.forEach(e => {
        ...
        _initExtensions() {
            this.trigger("initExtensions:before"), "array" == o(this.opts.extensions) && (this.opts.extensions = {all: this.opts.extensions});
                    ...
                    if (n && n.length > 1 && "#" == n.slice(0, 1)) {
                        try {
                            ...
                            if (t && t.matches(".mm-panel")) {
                                return e.parentElement.matches(".mm-listitem_vertical") ? this.togglePanel(t) : this.openPanel(t), !0
                            }
                        }
                        catch (e) {
                        }
        ...
        _initPanel(e) {
            if (this.trigger("initPanel:before", [e]), E(e, this.conf.classNames.panel, "mm-panel"), E(e, this.conf.classNames.nopanel, "mm-nopanel"), E(e, this.conf.classNames.inset, "mm-listview_inset"), e.matches(".mm-listview_inset") && e.classList.add("mm-nopanel"), e.matches(".mm-nopanel")) {
                return null;
            }
            var t = e.id || m(),
        ...
        _initNavbar(e) {
            ...
            var t = e.mmParent, n = b("div.mm-navbar"),
                i = this._getPanelTitle(e, this.opts.navbar.title), s = "";
            if (t) {
    ...
    const H = function () {
        ...
        var e = this.opts.offCanvas, t = this.conf.offCanvas;
        if (e.blockUI) {
            if (!S.node.blck) {
    ...
    var X = {
        menu: {open: !1, node: null, maxStartPos: 100, threshold: 50},
        panels: {close: !1},
        vendors: {hammer: {}}
    };
    var G = {
    ...
    var J = {
        fixed: {insertMethod: "append", insertSelector: "body"},
        sticky: {offset: 0}
    };
    ...
    function oe() {
        ...
        if (void 0 !== e) {
            ...
            e.length && (e.forEach(e => {
                ...
                var n = b("div.mm-navbar"), i = e.position;
    ...
    var de = {clear: !1, form: !1, input: !1, submit: !1}, ce = {
        Search: "جستجو",
    ...
    const fe = function () {
        ...
        var t = b("div.mm-panel_search"), n = b("ul");
        ...
        var s = b((n.form ? "form" : "div") + ".mm-searchfield"),
            a = b("div.mm-searchfield__input"), o = b("input");
        ...
        var i = _(this.node.pnls, ".mm-panel_search")[0], s = g(e, "input")[0],
    ...
    S.prototype.search = function (e, t) {
        ...
        var i = e.mmSearchfield, s = g(e.closest(".mm-searchfield"), ".mm-btn"),
            a = _(this.node.pnls, ".mm-panel_search")[0], o = i.panels,
            r = i.noresults, l = i.listitems, m = i.dividers;
        if (l.forEach(e => {
            ...
            m.forEach(e => {
                ...
                var i = _(e, ".mm-listitem__text")[0], s = !1;
                i && function (e) {
    ...
    S.addons = {
        offcanvas: function () {
                ...
                this._api.push("open", "close", "setPage"), this.vars.opened = !1, this.bind("initMenu:before", () => {
                    ...
                    this.node.menu.id && (this.node.menu.id = "mm-" + this.node.menu.id),
                        g(this.node.menu, "[id]").forEach(e => {
                                e.id = "mm-" + e.id;
                                if (e.type == 'checkbox' && e.nextElementSibling && e.nextElementSibling.tagName == 'LABEL') {
            ...
            if (U && this.opts.offCanvas && this.opts.offCanvas.blockUI) {
                ...
                if (this.opts.scrollBugFix = a(e, S.options.scrollBugFix), e.fix) {
                    ...
                    this.node.menu.addEventListener("scroll", o, {passive: !1}), this.node.menu.addEventListener("touchmove", e => {
                    ...
                    }, {passive: !1}), this.bind("open:start", () => {
            ...
            if (this.opts.autoHeight = a(e, S.options.autoHeight), "auto" != e.height && "highest" != e.height) {
                return;
            }
            const t = (() => {
                const t = () => {
                ...
                return () => {
                    if (!this.opts.offCanvas || this.vars.opened) {
                        var i = window.getComputedStyle(this.node.pnls),
                            ...
                            a = Math.max(parseInt(i.bottom, 10), 0) || 0, o = 0;
            ...
            if (this.opts.columns = a(e, S.options.columns), e.add) {
                ...
                for (var t = [], n = [], i = ["mm-panel_opened", "mm-panel_opened-parent", "mm-panel_highest"], s = 0; s <= e.visible.max; s++) {
                    t.push("mm-menu_columns-" + s), n.push("mm-panel_columns-" + s);
                }
            ...
            if (this.opts.counters = a(e, S.options.counters), this.bind("initListview:after", e => {
                ...
                if (t.matches(e.addTo)) {
                    ...
                    if (n && !n.querySelector(".mm-counter")) {
                        let e = b("span.mm-counter"), t = _(n, ".mm-btn")[0];
                        t && t.prepend(e)
                    }
                }
            }), e.count) {
            ...
            var e = function (e) {
                return "boolean" == typeof e && (e = {add: e}), "object" != typeof e && (e = {}), "panels" == e.addTo && (e.addTo = ".mm-panel"), e
            }(this.opts.dividers);
            ...
            if (this.opts.offCanvas && !("function" != typeof window.Hammer || window.Hammer.VERSION < 2)) {
                var e = function (e) {
                    return "boolean" == typeof e && (e = {
                        menu: e,
                        panels: e
                    }), "object" != typeof e && (e = {}), "boolean" == typeof e.menu && (e.menu = {open: e.menu}), "object" != typeof e.menu && (e.menu = {}), "boolean" == typeof e.panels && (e.panels = {close: e.panels}), "object" != typeof e.panels && (e.panels = {}), e
                }(this.opts.drag);
                ...
                e.menu.open && this.bind("setPage:after", () => {
                    var i, s, a, o = {
                            ...
                            close_dir: "left",
                            negative: !1
                        }, l = "width", m = "innerWidth", d = o.open_dir,
                        c = function (t) {
                            t <= e.menu.maxStartPos && (h = 1)
                        }, p = function () {
                            return g(document.body, ".mm-slideout")
                        }, h = 0, f = 0, u = 0, v = this.opts.extensions.all,
            ...
            if (this.opts.offCanvas) {
                ...
                if (e.drop) {
                    ...
                    this.bind("initMenu:after", () => {
                        ...
                        if ("string" == typeof e.position.of) {
                            ...
                            1 == t.length && (t[1] = t[0]), "hover" == t[0] && n.addEventListener("mouseenter", e => {
                                this.open()
                            }, {passive: !0}), "hover" == t[1] && this.node.menu.addEventListener("mouseleave", e => {
                                this.close()
                            }, {passive: !0})
                        }
                    ...
                    this.bind("open:start", s), window.addEventListener("resize", e => {
                        s.call(this)
                    }, {passive: !0}), this.opts.offCanvas.blockUI || window.addEventListener("scroll", e => {
                        s.call(this)
                    }, {passive: !0})
                }
            }
            ...
            if (this.opts.iconbar = a(t, S.options.iconbar), t.use && (["top", "bottom"].forEach((n, i) => {
                ...
                let n = "mm-menu_iconbar-" + t.position, i = () => {
        ...
        }, navbars: oe, pageScroll: function () {
            var e = function (e) {
            ...
            if (e.scroll && this.bind("close:finish", () => {
                ...
                if (t = null, n.inMenu) {
                    ...
                    if (t = s(a)) {
                        return this.node.menu.matches(".mm-menu_sidebar-expanded") && this.node.wrpr.matches(".mm-wrapper_sidebar-expanded") ? void i() : {close: !0}
                    }
                }
            }), e.update) {
                let e = [];
            ...
            if (this.opts.offCanvas) {
                ...
                if (e.expanded.use) {
                    ...
                    "closed" == t && this.bind("initMenu:after", () => {
                        ...
                        if (n.inMenu && n.inListview && this.node.wrpr.matches(".mm-wrapper_sidebar-expanded")) {
                ...
                e.append(t), _(this.node.menu).forEach(e => {
                    switch (!0) {
                        ...
                        case e.matches(".form-inline"):
                            ...
                            }, this.conf.searchfield.input = {name: e.querySelector("input").getAttribute("name") || null}, this.conf.searchfield.clear = !1, this.conf.searchfield.submit = !0;
                            break;
                        default:
        ...
        return this.each((i, s) => {
            ...
            let a = new S(s, e, t), o = we(a.node.menu);
