...
(function ($) {
    $.JSortableList = function (tableWrapper, formId, sortDir, saveOrderingUrl, options, nestedList) {
        ...
        var ops = $.extend({
            ...
            orderingWrapper: 'input-prepend', //ordering control wrapper class
                                              // name
        ...
        //make wrapper table position be relative, to fix y-axis drag problem
        // on Safari
        ...
        $(tableWrapper).sortable({
            ...
            stop: function (e, ui) {
                ...
                if (saveOrderingUrl) {
                    //clone and check all the checkboxes in sortable range to
                    // post
