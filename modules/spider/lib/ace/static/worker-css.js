...
!(function (window) {
	...
	window.require = function require(parentId, id) {
		...
		window.require.modules[id] = {}; // prevent infinite loop on broken
	                                     // modules
		importScripts(path);
		...
		window.require.modules[id] = {
			...
			factory: function () {
				...
				var returnExports = factory.apply(this, deps.slice(0, factory.length).map(function (dep) {
					switch (dep) {
						// Because "require", "exports" and "module" aren't
						// actual dependencies, we must handle them seperately.
						case "require":
							return req;
						case "exports":
							return module.exports;
						case "module":
							return module;
						// But for all other dependencies, we can just go ahead
						// and require them.
						default:
							return req(dep);
					}
...
ace.define("ace/mode/css/csslint", [], function (require, exports, module) {
	...
	var CSSLint = (function () {
		...
		api.getRuleset = function () {
			...
			while (i < len) {
				ruleset[rules[i++].id] = 1;    //by default, everything is a
			                                   // warning
			}
	...
	CSSLint.addRule({
		...
		init: function (parser, reporter) {
			...
			function startRule(event) {
				var i, len, selector, p, n, pLen, part, part2, type,
