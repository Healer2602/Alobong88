...
(function(){function a(b){var c=b.dataset.flatpickr?JSON.parse(b.dataset.flatpickr):{},e={};"undefined"!=typeof flatpickrDefaults&&(e=flatpickrDefaults);c=Object.assign(e,c);c.enableTime&&c.hasOwnProperty("datetimeFormat")&&(c.dateFormat=c.datetimeFormat);b.flatpickr(c)}var d=document.querySelectorAll("[data-flatpickr]");jQuery().flatpickr&&d&&[].forEach.call(d,function(b){a(b)});$.flatpickr=function(b){jQuery().flatpickr&&[].forEach.call(b,function(c){a(c)})}})();
