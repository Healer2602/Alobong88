 ...
 * Released under Creative Commons Attribution-NonCommercial 3.0 Unported
 * License.
 *
...
tinymce.PluginManager.add('filemanager', function (editor) {
	...
	function filemanager(callback, value, meta) {
		...
		var dialogUrl = editor.settings.external_filemanager_path + '?editor=tinymce&type=' + urltype + '&descending=' + descending + sort_by + fldr + crossdomain + '&lang=' + editor.settings.language + '&akey=' + akey;
